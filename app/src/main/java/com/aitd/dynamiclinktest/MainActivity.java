package com.aitd.dynamiclinktest;
        ...
        FirebaseDynamicLinks.getInstance()
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (deepLink != null) {
//                            txtShowDL = (TextView) findViewById(R.id.txtShowDL);
//                            txtShowDL.setText("Found deep link!");
                            Toast.makeText(getApplicationContext(), "Found deep link!", Toast.LENGTH_SHORT).show();
